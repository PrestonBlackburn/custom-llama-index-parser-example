...
def test_metadata_h1(parsed_doc):
    first_h1_metadata={'h1': '# Example H1 - Section A', 'h2': None, 'filename': 'example_source.md', 'extension': '.md'}
    assert first_h1_metadata == parsed_doc[0].metadata

def test_metadata_h2(parsed_doc):
    last_h2_metadata = metadata={'h1': 'Example H1 - Section B', 'h2': 'Example h2 in section b', 'filename': 'example_source.md', 'extension': '.md'}
